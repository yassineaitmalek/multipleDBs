...
@EnableJpaRepositories(entityManagerFactoryRef = MemDB.DB
    + BasePackage.EMF, transactionManagerRef = MemDB.DB
        + BasePackage.TM, basePackages = { BasePackage.BASE_REPO + MemDB.DB })

public class MemDB {

  private final Environment env;

  public static final String DB = "mem";
